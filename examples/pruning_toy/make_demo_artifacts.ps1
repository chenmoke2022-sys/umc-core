  ...
  @'
{
  "schema_version": "1.0",
  "data_status": "example",
  "baseline": { "name": "toy pruning experiment (example)", "version": "n/a", "quant_profile": "n/a", "backend": "pytorch" },
  ...
  "metrics": {
    ...
    "toy_acc_before": 0.0, "toy_acc_after_magnitude": 0.0, "toy_acc_after_random": 0.0, "toy_sparsity": 0.0
  }
}
'@ | Set-Content -Encoding UTF8 (Join-Path $art "results.json")

  @'
# Pruning toy report (example)

This is an example placeholder. Run `pwsh .\examples\pruning_toy\run.ps1` to generate measured results.

...
try {
  $art = ".\\examples\\vla_alignment_toy\\artifacts"
  ...
  @'
{
  "schema_version": "1.0",
  "data_status": "example",
  "baseline": { "name": "toy VLA alignment (example)", "version": "n/a", "quant_profile": "n/a", "backend": "pytorch" },
  ...
  "metrics": {
    ...
    "toy_linear_loss_start": 0.0, "toy_linear_loss_end": 0.0, "toy_linear_at1_start": 0.0, "toy_linear_at1_end": 0.0,
    "toy_mlp_loss_start": 0.0, "toy_mlp_loss_end": 0.0, "toy_mlp_at1_start": 0.0, "toy_mlp_at1_end": 0.0
  },
  "notes": "Example placeholder. Run examples/vla_alignment_toy/run.ps1 to generate measured results."
}
'@ | Set-Content -Encoding UTF8 (Join-Path $art "results.json")

  @'
# VLA alignment toy report (example)
